      ...
      <div className="container mx-auto max-w-5xl">
        ...
        {items.length > 0 && (
          <Link href="/pantry/recipes" className="block mb-8">
            <div className="bg-emerald-700 p-6 border-2 border-emerald-900 rounded-xl shadow-lg hover:shadow-xl hover:-translate-y-1 transition-all cursor-pointer group">
              <div className="flex items-center gap-4">
                <div className="bg-white/30 p-3 border-2 border-white/40 rounded-xl group-hover:bg-white/40 transition-colors">
                  <ChefHat className="w-8 h-8 text-white fill-white" />
                </div>
                ...
                <div className="hidden sm:block">
                  <Badge className="bg-white/30 text-white border-2 border-white/40 font-bold uppercase tracking-wide">
                    {items.length} items
                  </Badge>
                </div>
              </div>
